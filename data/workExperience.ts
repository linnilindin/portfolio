...
export const workExperiences: WorkExperience[] = [
  ...
  },
  {
    ...
    description: 'Redesigned the media carousel interface that students and staff use to access learning modules, making it much easier to navigate. Handled a full website migration to a new domain without any downtime. Also customized Salesforce features using Apex to improve how course administrators manage the system.',
  ...
  },
  {
    ...
    description: 'Help students and staff troubleshoot tech issues across the universitys systems. Break down technical problems in ways that make sense to non-technical users. Use ServiceNow to track and document issues, knowing when to solve things directly and when to escalate to specialized teams.',
